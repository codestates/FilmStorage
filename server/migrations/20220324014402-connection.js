...
module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    await queryInterface.removeConstraint("filmlog_comments", "FK_filmlog_comments_users");
    await queryInterface.removeConstraint("filmlog_comments", "FK_filmlog_comments_filmlogs");
    await queryInterface.removeConstraint("filmtalk_comments", "FK_filmtalk_comments_users");
    await queryInterface.removeConstraint("filmtalk_comments", "FK_filmtalk_comments_filmtalks");
